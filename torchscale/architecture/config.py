...
class EncoderConfig(object):
    def __init__(self, **kwargs):
        ...
        self.sparse_ratio = kwargs.pop("sparse_ratio", 1)
        self.dilated_embed_ratio = kwargs.pop("dilated_embed_ratio", 1)
        self.dilated_head_ratio = kwargs.pop("dilated_head_ratio", 1)
        self.model_parallel_size = kwargs.pop("model_parallel_size", 1)
        self.group_norm_size = kwargs.pop("group_norm_size", 1)
        self.block_size = kwargs.pop("block_size", 0)
        self.subblock_size = kwargs.pop("subblock_size", 0)
        self.tokens_per_sample = kwargs.pop("tokens_per_sample", 2048)
        self.gating_conv = kwargs.pop("gating_conv", False)
        self.multi_scale = kwargs.pop("multi_scale", False)
        self.sparse_qkv = kwargs.pop("sparse_qkv", False)
        self.window_size = kwargs.pop("window_size", 0)
        self.window_sparse_ratio = kwargs.pop("window_sparse_ratio", 0)
        self.large_block_size = kwargs.pop("large_block_size", 0)
        self.large_sparse_ratio = kwargs.pop("large_sparse_ratio", 0)
...
class DecoderConfig(object):
    def __init__(self, **kwargs):
        ...
        self.deepnorm = kwargs.pop("deepnorm", False)
        self.subln = kwargs.pop("subln", True)
        self.sope_rel_pos = kwargs.pop("sope_rel_pos", True)
